import { ArrowLeftToLine, ChartNoAxesColumn, ChevronDown, Filter, Plus, Search } from "lucide-react";
        ...
        <div className="flex items-center justify-between mx-6 my-3 text-sm">
            <div className="flex items-center gap-3 divide-x divide-gray-400">
                <div className="flex items-center gap-1 cursor-pointer">
                    <span className="text-[#E95420]">Status</span> <ChevronDown size={15} />
                </div>
                <div className="flex items-center gap-1 cursor-pointer pl-3">
                    <ChartNoAxesColumn size={15} className="rotate-180 text-[#E95420]" /><span className="text-[#E95420]">Status</span> <ChevronDown size={15} />
                </div>
                <div className="flex items-center gap-1 cursor-pointer pl-3">
